...
DEFAULT_EXECUTION_HTTP_APIS = "debug,admin,eth,engine"
DEFAULT_EXECUTION_WS_APIS = "debug,admin,eth,engine"
DEFAULT_EXECUTION_HTTP_PORT = 8545
DEFAULT_EXECUTION_WS_PORT = 8546
DEFAULT_EXECUTION_P2P_PORT = 30303
DEFAULT_EXECUTION_ENGINE_PORT = 8551
