...
DEFAULT_CONSENSUS_CONFIG = {
    DEFAULT_CONSENSUS_CLIENT_CONFIG_NAME_PRYSM: {"client": "prysm"},
    DEFAULT_CONSENSUS_CLIENT_CONFIG_NAME_LIGHTHOUSE: {"client": "lighthouse"},
    DEFAULT_CONSENSUS_CLIENT_CONFIG_NAME_LODESTAR: {"client": "lodestar"},
    DEFAULT_CONSENSUS_CLIENT_CONFIG_NAME_NIMBUS: {"client": "nimbus"},
    DEFAULT_CONSENSUS_CLIENT_CONFIG_NAME_TEKU: {"client": "teku"}
}
