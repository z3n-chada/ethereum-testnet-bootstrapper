...
from modules.Consensus import ConsensusFork, Epoch
from modules.Utils import get_logger, logging_levels
from modules.ETBConfig import ETBConfig, ClientInstance, get_etb_config
...
if __name__ == "__main__":
    ...
    node_watcher = SimpleNodeWatch2(logger=logger, etb_config=etb_config, max_retries=args.max_retries,
